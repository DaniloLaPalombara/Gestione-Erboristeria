...
class Ui_herbalife(object):
    nProdSelezionati = 0
    totale = []
    prodSelezionati = []

    def setupUi(self, herbalife):
        self.Frame = herbalife
        herbalife.setObjectName("angelini")
        herbalife.resize(937, 587)
        self.label_4 = QtWidgets.QLabel(herbalife)
        ...
        self.ricercafornitorebtn = QtWidgets.QPushButton(herbalife)
        ...
        self.carrellobtn.setStyleSheet("border-radius: 10px;\n"
                                       ...
                                       "")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/no/loghi-icone/iconacarrello.PNG"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.carrellobtn.setIcon(icon1)
        self.carrellobtn.setIconSize(QtCore.QSize(30, 30))
        self.carrellobtn.setObjectName("carrellobtn")
        self.label_3 = QtWidgets.QLabel(herbalife)
        ...
        self.frame = QtWidgets.QFrame(herbalife)
        self.frame.setGeometry(QtCore.QRect(-10, -10, 951, 601))
        self.frame.setStyleSheet("background-image: url(" + gestore.returnPth() + "loghi-icone/herbalife.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.pushButton = QtWidgets.QPushButton(herbalife)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/no/loghi-icone/iconaindietro.PNG"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon2)
        self.pushButton.setIconSize(QtCore.QSize(40, 40))
        self.pushButton.setObjectName("pushButton")
        self.homebtn = QtWidgets.QPushButton(herbalife)
        ...
        self.tableWidgetlist = QtWidgets.QTableWidget(herbalife)
        ...
        self.tableWidgetcarrello = QtWidgets.QTableWidget(herbalife)
        ...
        self.acquistabtn = QtWidgets.QPushButton(herbalife)
        ...
        self.acquistabtn.setStyleSheet("border-radius: 10px;\n"
                                       ...
                                       "")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/no/loghi-icone/iconadollaro.PNG"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.retranslateUi(herbalife)
        QtCore.QMetaObject.connectSlotsByName(herbalife)

    def retranslateUi(self, herbalife):
        _translate = QtCore.QCoreApplication.translate
        herbalife.setWindowTitle(_translate("herbalife", "Form"))
        self.label_4.setText(_translate("herbalife", "Lista prodotti:"))
        self.ricercafornitorebtn.setText(_translate("herbalife", "  Ricerca"))
        self.label.setText(_translate("herbalife", "Inserisci codice e quantità da comprare"))
        self.carrellobtn.setText(_translate("herbalife", "Metti nel carrello"))
        self.label_3.setText(_translate("herbalife", "Carrello:"))
        self.homebtn.setText(_translate("herbalife", "Home"))
        self.acquistabtn.setText(_translate("herbalife", "  Acquista"))
    ...
    def popolaListaProdotti(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        item.setText(_translate("herbalife", "Prodotto"))
        item = self.tableWidgetlist.horizontalHeaderItem(1)
        item.setText(_translate("herbalife", "Quantità"))
        item = self.tableWidgetlist.horizontalHeaderItem(2)
        item.setText(_translate("herbalife", "Prezzo"))
        item = self.tableWidgetlist.horizontalHeaderItem(3)
        item.setText(_translate("herbalife", "Codice"))
        for riga in range(len(data.listaFitoFornitore)):
            for colonna in range(4):
                ...
                if colonna == 0:
                    item.setText(_translate("herbalife", prodotto.get('nome')))
                elif colonna == 1:
                    item.setText(_translate("herbalife", str(prodotto.get('quantita'))))
                elif colonna == 2:
                    item.setText(_translate("herbalife", str(prodotto.get('prezzo'))))
                elif colonna == 3:
                    item.setText(_translate("herbalife", prodotto.get('codice')))
        ...
        for riga in range(data.nFitoForn, data.nFitoForn + data.nProdForn):
            for colonna in range(4):
                ...
                if colonna == 0:
                    item.setText(_translate("herbalife", prodotto.get('nome', 'N/D')))
                elif colonna == 1:
                    item.setText(_translate("herbalife", str(prodotto.get('quantita', 'N/D'))))
                elif colonna == 2:
                    item.setText(_translate("herbalife", str(prodotto.get('prezzo', 'N/D'))))
                elif colonna == 3:
                    item.setText(_translate("herbalife", prodotto.get('codice', 'N/D')))
    ...
    def popolaRicerca(self, prodRicercati):
        ...
        for i, header in enumerate(headers):
            ...
            item.setText(_translate("herbalife", header))
        for riga, prodotto in enumerate(prodRicercati):
            for colonna in range(4):
                ...
                self.tableWidgetlist.setItem(riga, colonna, item)
                if colonna == 0:
                    item.setText(_translate("herbalife", prodotto['nome']))
                elif colonna == 1:
                    item.setText(_translate("herbalife", str(prodotto['quantita'])))
                elif colonna == 2:
                    item.setText(_translate("herbalife", str(prodotto['prezzo'])))
                elif colonna == 3:
                    item.setText(_translate("herbalife", prodotto['codice']))
    ...
    def popolaCarrello(self, nProdSelezionati):
        ...
        for colonna in range(4):  # Numero di colonne
            ...
            if colonna == 0:  # Nome del prodotto
                ...
                item.setText(_translate("herbalife", str(self.quantitaprodsb.value())))
    ...
    def modificaCarrello(self, riga, elemrimosso):
        ...
        for colonna in range(4):  # Numero di colonne
            ...
            if colonna == 0:  # Nome del prodotto
                item.setText(_translate("herbalife", elemrimosso['nome']))
            elif colonna == 1:  # Quantità
                item.setText(_translate("herbalife", str(self.quantitaprodsb.value())))
            elif colonna == 2:  # Prezzo
                item.setText(_translate("herbalife", str(elemrimosso['prezzo'])))
            elif colonna == 3:  # Codice
                item.setText(_translate("herbalife", elemrimosso['codice']))
